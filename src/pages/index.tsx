...
export const metadata: Metadata = {
    ...
    description: "Online Playground IDEs",
    themeColor: [{
            color: "#000000",
        }],
    openGraph: {
                        ...
                        <div>
                            <div>
                                <Link href="/" passHref legacyBehavior>
                                    <LegacyImage height={64} width={64} src={LogoIcon} alt="rdamn Logo"/>
                                </Link>
                            </div>
                            ...
                            <div className="mt-12 sm:max-w-lg sm:w-full sm:flex">
                                <div className="mt-4 sm:mt-0 sm:ml-3">
                                    <Link href="/playgrounds" className="block w-full px-5 py-3 text-lg font-bold text-center text-black bg-red-500 border border-transparent rounded-md shadow hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-red-500 focus:ring-offset-2 sm:px-10">
                                ...
                                <div className="mt-12 sm:mx-auto sm:max-w-lg sm:flex">
                                    <div className="flex-1 mt-4 sm:mt-0 sm:ml-3">
                                        <a href="https://codedamn.com">
                                            <button type="submit" className="block w-full px-5 py-3 text-base font-medium text-white bg-gray-900 border border-transparent rounded-md shadow hover:bg-black focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-red-500 sm:px-10">
