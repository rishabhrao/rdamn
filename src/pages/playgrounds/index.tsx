				...
				<div className="flex flex-col m-5">
					...
					<ul role="list" className="grid grid-cols-1 gap-6 m-5 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
						{playgrounds.map(playground => (
							<li key={playground.playgroundId} className="flex flex-col col-span-1 text-center bg-white divide-y divide-gray-200 rounded-lg shadow">
								<div className="flex flex-col flex-1 p-8">
									{playground.playgroundTemplate === "html" ? (
										<svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-24 mx-auto h-2w-24" fill="current" viewBox="0 0 299.215 299.215" stroke="none">
									...
									) : playground.playgroundTemplate === "nextjs" ? (
										<svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-24 mx-auto h-2w-24" fill="none" viewBox="0 0 15 15" stroke="none">
											<path
												fillRule="evenodd"
												clipRule="evenodd"
												fill="black"
										...
										<svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-24 mx-auto h-2w-24" fill="none" viewBox="0 0 24 24" stroke="currentColor">
											<path
												strokeLinecap="round"
									...
									<div className="flex flex-col justify-between flex-grow mt-1">
										<p className="text-sm text-gray-500">
											Created at {new Date(playground.createdAt).toLocaleTimeString([], { year: "numeric", month: "short", day: "numeric", hour: "numeric", minute: "numeric" })}
										</p>
								...
								<div className="flex -mt-px divide-x divide-gray-200">
									<div className="flex flex-1 w-0">
										<Link href={`/playground/${playground.playgroundId}`}>
							...
							<div className="inline-block px-6 pt-5 pb-12 overflow-hidden text-left align-bottom transition-all transform bg-white rounded-lg shadow-xl sm:my-8 sm:align-middle sm:pb-16 sm:px-10">
								...
								<div className="mt-2 form-control">
									...
									<input
										...
										className="relative w-full py-2 pl-3 pr-10 text-left bg-white border border-gray-300 rounded-md shadow-sm cursor-default input focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm"
											...
											<Listbox.Button className="relative w-full py-2 pl-3 pr-10 text-left bg-white border border-gray-300 rounded-md shadow-sm cursor-default focus:outline-none focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
												<span className="flex items-center">
													{newPlaygroundTemplate === "html" ? (
														...
														<svg xmlns="http://www.w3.org/2000/svg" className="flex-shrink-0 w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
															<path
																strokeLinecap="round"
																strokeLinejoin="round"
																strokeWidth={2}
											...
											<Listbox.Options className="absolute z-[999999999] w-full py-1 mt-1 overflow-auto text-base bg-white rounded-md shadow-lg max-h-56 ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm">
												<Listbox.Option
													className={`cursor-default select-none relative py-2 pl-3 pr-9 ${
														newPlaygroundTemplate === "html" ? "text-white bg-indigo-600" : "hover:bg-gray-300 text-gray-900"
													}`}
													value={"html"}
												>
													{({ selected, active }) => (
												...
												<Listbox.Option
													className={`cursor-default select-none relative py-2 pl-3 pr-9 ${
														newPlaygroundTemplate === "nextjs" ? "text-white bg-indigo-600" : "hover:bg-gray-300 text-gray-900"
													}`}
													value={"nextjs"}
												>
													{({ selected, active }) => (
